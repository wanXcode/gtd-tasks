...
--   2) First version uses reminder name as best-effort event_id suffix.
--   3) We intentionally avoid completion-date access first for better AppleScript compatibility across macOS versions.
